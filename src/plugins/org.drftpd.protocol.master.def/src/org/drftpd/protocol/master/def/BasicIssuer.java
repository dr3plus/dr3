 ...
 * @version $Id: BasicIssuer.java 2041 2010-04-11 18:36:43Z djb61 $
 */
public class BasicIssuer extends AbstractBasicIssuer {
	...
	public String issueDeleteToSlaveArchivejob(RemoteSlave rslave, String sourceFile) throws SlaveUnavailableException {
		String index = rslave.fetchIndex();
		rslave.sendCommand(new AsyncCommandArgument(index, "deleteArchivejob", sourceFile));
	...
	public String issueRemergeToSlave(RemoteSlave rslave, String path, boolean partialRemerge, long skipAgeCutoff, long masterTime, boolean instantOnline, boolean CRCRemerge)
		throws SlaveUnavailableException {
		String index = rslave.fetchIndex();
		rslave.sendCommand(new AsyncCommandArgument(index, "remerge", new String[]{path, 
				Boolean.toString(partialRemerge), Long.toString(skipAgeCutoff), Long.toString(masterTime), Boolean.toString(instantOnline), Boolean.toString(CRCRemerge)}));
		return index;
	}

...
/**
 * @author djb61
 * @version $Id: ZipscriptVFSDataSFV.java 1983 2009-08-23 16:51:16Z djb61 $
 */
public class ZipscriptVFSDataSFV {

	private static DirectoryHandle _dir;
	...
	private static SFVInfo getSFVInfoFromInode(DirectoryHandle vfsDirHandle) throws FileNotFoundException, KeyNotFoundException {
		return vfsDirHandle.getPluginMetaData(SFVInfo.SFVINFO);
	}
	
	private static SFVInfo fetchSFVInfoFromIndex(RemoteSlave rslave, String index) throws RemoteIOException, SlaveUnavailableException {
		return ((AsyncResponseSFVInfo) rslave.fetchResponse(index)).getSFV();
	}
	
	private static ZipscriptIssuer getSFVIssuer() {

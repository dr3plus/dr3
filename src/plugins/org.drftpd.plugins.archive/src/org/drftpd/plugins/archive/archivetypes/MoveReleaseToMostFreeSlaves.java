...
public class MoveReleaseToMostFreeSlaves extends ArchiveType {
    ...
    public String toString() {
    	return "MoveReleaseToMostFreeSlaves=[directory=[" + getDirectory().getPath() + "]dest=[" + outputSlaves(findDestinationSlaves()) + "]numOfSlaves=[" + _numOfSlaves + "]MinimumnumOfSlaves=[" + _minnumOfSlaves + "]]";
    }	

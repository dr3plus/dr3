...
public class MoveReleaseToSpecificSlaves extends ArchiveType {
    ...
    public String toString() {
        return "MoveReleaseToSpecificSlaves=[directory=[" + getDirectory().getPath() + "]dest=[" + outputSlaves(findDestinationSlaves()) + "]numOfSlaves=[" + _numOfSlaves + "]MinimumnumOfSlaves=[" + _minnumOfSlaves + "]]";
    }	
